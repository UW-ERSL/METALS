...
# --- Support Functions ---
from MMTO_obj_cons_sensitivities import compute_pnorm_safety_factor_and_sensitivity,compute_pnorm_stress_and_sensitivity, d_relaxed_von_mises_dE, MaterialModel
    ...
    if objectiveType == TO_QOI.COMPLIANCE:
        ...
        for e in range(num_elems):
            ...
            d_sigma_vm_dE[e] = d_relaxed_von_mises_dE(
                fe_solver_structural.stressComponents[e], x[e].item(), q=1) / EDesign[e].item()
