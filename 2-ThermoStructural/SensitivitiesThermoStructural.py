...
from topopt_material_model import get_thermal_material_model_scaling, get_structural_material_model_scaling, get_structural_material_model_sensitivity, get_thermal_material_model_sensitivity# type: ignore
