...
from topopt_material_model import MaterialModel, get_stress_relaxation_correction, get_stress_relaxation_factor_sensitivity, get_pNorm_exponent, get_structural_material_model_sensitivity, get_structural_material_model_scaling # type: ignore[reportMissingImports]