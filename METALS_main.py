...
from METALS_obj_cons_sensitivities import (
...
def run_topopt(
    ...
    bc_struct, bc_thermal, elem_body_force, to_params, vae_params = getMETALSTOProblem(to_problem, nDOFDesired=nDOFDesired)
    ...
    def METALS_optimization_function(zeta):
        ...
        thermalConductivity = material_properties['Thermal_conductivity']
        ...
        obj, grad_obj = compute_mmto_objective_and_gradient(
            to_params, sol, T, zeta, fe_solver_structural, KETemplate, matEncoder)
        ...
        shared_vars['Youngs_Modulus'] = EDesign
...
if __name__ == "__main__":
    ...
    to_problem = METALSTOExamples.LBracketThermal
