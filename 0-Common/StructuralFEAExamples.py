...
class StructuralFEAExamples(enum.Enum):
...
def getStructuralFEAProblem(problem: StructuralFEAExamples,nDOFDesired: int = 20000, **kwargs):
  ...
  **kwargs : dict
  ...
  """
  if problem == StructuralFEAExamples.EdgeCantilever:
    return createEdgeCantileverProblem(nDOFDesired=nDOFDesired,**kwargs)
  
  elif problem == StructuralFEAExamples.BliskSection:
    return createBliskSectionProblem(nDOFDesired=nDOFDesired,**kwargs)
  
  elif problem == StructuralFEAExamples.Bridge:
  ...
  elif problem == StructuralFEAExamples.BridgeSaitou:
    return createBridgeProblemSaitou(nDOFDesired=nDOFDesired,**kwargs)
  elif problem == StructuralFEAExamples.CantileverBenchmark:
